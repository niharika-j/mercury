...
function ResearchPage() {
    ...
    let merchantInsights = ["Merchants need a way to calculate value of marketing using CLOs. They do not trust the existing reports by rewards programs and believe that they take credit of their returning customers.", "POS systems can potentially help merchants gain trust in rewards programs.", "Merchants want more control over where their business is advertised.", "Symbiotic partnerships with other local businesses targeting similar customer segments is another preferred way for marketing."];
